...
bool Favorites::addGame(const QString &aIdUser, const QString &aIcon, const int &aAppid, const QString &aName, bool aElseRemove) {
    auto iterator = std::find_if(_fGame.begin(), _fGame.end(), [=](FavoriteGame &game) {
                                                                    return (aIdUser == game.getUserId())
                                                                            && (aAppid == game.getAppid())
                                                                            && (aName == game.getName());
                                                                });
    if (iterator == _fGame.end()) {
        _fGame.append(FavoriteGame(aIdUser, aIcon, aAppid, aName));
        saveGames();
        return true;
    } else {
        (*iterator).setIcon(aIcon);
        if (aElseRemove) {
            removeGame(aIdUser, aIcon, aAppid, aName);
        }
        return false;
    }
}
...
bool Favorites::addFriend(const QString &aIdUser, const QDateTime &aAdded, const QString &aId, const QString &aName, bool aElseRemove) {
    auto iterator = std::find_if(_fFriend.begin(), _fFriend.end(), [=](FavoriteFriend &steamFriend) {
                                                                        return (aIdUser == steamFriend.getUserId())
                                                                                && (aName == steamFriend.getName())
                                                                                && (aId == steamFriend.getId());
                                                                    });
    if (iterator == _fFriend.end()) {
        _fFriend.append(FavoriteFriend(aIdUser, aAdded, aId, aName));
        saveFriends();
        return true;
    } else {
        (*iterator).setAdded(aAdded);
        if (aElseRemove) {
            removeFriend(aIdUser, aAdded, aId, aName);
        }
        return false;
    }
}
...
bool Favorites::removeGame(const QString &aIdUser, const QString &aIcon, const int &aAppid, const QString &aName, bool aElseRemove) {
    ...
    if (iterator == _fGame.end()) {
        if (aElseRemove) {
            addGame(aIdUser, aIcon, aAppid, aName);
        }
        return false;
    } else {
...
bool Favorites::removeGame(const QString &aIdUser, const SGame &aGame, bool aElseRemove) {
    auto iterator = std::remove_if(_fGame.begin(), _fGame.end(), [=](FavoriteGame &game) {
                                                                    return (aIdUser == game.getUserId())
                                                                            && (aGame._appID == game.getAppid())
                                                                            && (aGame._name == game.getName());
...
bool Favorites::removeFriend(const QString &aIdUser, const SProfile &aProfileFriend, const SFriend &aFriendLink, bool aElseRemove) {
...
bool Favorites::removeFriend(const QString &aIdUser, const QDateTime &aAdded, const QString &aId, const QString &aName, bool aElseRemove) {
    auto iterator = std::remove_if(_fFriend.begin(), _fFriend.end(), [=](FavoriteFriend &steamFriend) {
                                                                        return (aIdUser == steamFriend.getUserId())
                                                                                && (aName == steamFriend.getName())
                                                                                && (aId == steamFriend.getId());
    ...
    if (iterator == _fFriend.end()) {
        if (aElseRemove) {
            addFriend(aIdUser, aAdded, aId, aName);
        }
        return false;
    } else {
        _fFriend.erase(iterator, _fFriend.end());
...
bool Favorites::removeAchievement(const QString &aIdUser, const SGame &aGame, const SAchievement &aAchievement, bool aElseRemove) {
...
void FavoriteGame::fromJson(QJsonObject aGame) {
...
void FavoriteFriend::fromJson(QJsonObject aFriend) {
...
void FavoriteAchievement::fromJson(QJsonObject fag) {
    _id             = fag["id"].toString();
...
void FavoriteAchievementsGame::fromJson(QJsonObject achievements) {
