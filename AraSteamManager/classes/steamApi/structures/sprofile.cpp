...
QPixmap SProfile::pixmapAvatar() const {
    return QPixmap::fromImage(loadImage(_pixmapAvatar, _avatar, Paths::imagesProfiles(_avatar), QSize(32, 32)));
}

QPixmap SProfile::pixmapAvatarMedium() const {
    return QPixmap::fromImage(loadImage(_pixmapAvatarMedium, _avatarMedium, Paths::imagesProfiles(_avatarMedium), QSize(64, 64)));
}

QPixmap SProfile::pixmapAvatarFull() const {
    return QPixmap::fromImage(loadImage(_pixmapAvatarFull, _avatarFull, Paths::imagesProfiles(_avatarFull), QSize(128, 128)));
}
