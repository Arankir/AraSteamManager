...
#define tableview {
                ...
                "} "
                "QTableView::item:alternate:hover:!selected { "
...
#define listview {
                ...
                "QListView::item { "
                    ...
                    "padding: 4px; "
                "} "
                "QListView#ListWidgetAll, QListView#ListWidgetCategory { "
                    "border: 0px solid #cccccc; "
                    //"border-radius: 8px; "
                    "background-color: rgba(30, 41, 59, 0.5); "// + backgroundGradient +
                "} "
                "QListView#ListWidgetAll::item, QListView#ListWidgetCategory::item { "
                    "background-color: rgba(23, 26, 33, 0.5); "
                    "color: #dddddd; "
                    "margin-top: 10px; "
                    "padding: 4px; "
