...
QT_MOC_LITERAL(3, 30, 20), // "SAchievementsGlobal*"
QT_MOC_LITERAL(4, 51, 4), // "Load"
QT_MOC_LITERAL(5, 56, 14), // "QNetworkReply*"
QT_MOC_LITERAL(6, 71, 5) // "Reply"

    },
    "SAchievementsGlobal\0finished\0\0"
    "SAchievementsGlobal*\0Load\0QNetworkReply*\0"
    "Reply"
};
...
void SAchievementsGlobal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finished((*reinterpret_cast< SAchievementsGlobal*(*)>(_a[1]))); break;
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< SAchievementsGlobal* >(); break;
            }
            break;
        case 2:
            switch (*reinterpret_cast<int*>(_a[1])) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SAchievementsGlobal::finished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SAchievementsGlobal::finished(SAchievementsGlobal * _t1)
{
...
// SIGNAL 1
void SAchievementsGlobal::finished()
{
