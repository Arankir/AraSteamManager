...
#include <memory>
#include "../../AraSteamManager/classes/threads/thread/threadachievements.h"
...
QT_MOC_LITERAL(1, 19, 10), // "s_progress"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 8), // "progress"
QT_MOC_LITERAL(4, 40, 3), // "max"
QT_MOC_LITERAL(5, 44, 15), // "s_finishedModel"
QT_MOC_LITERAL(6, 60, 19), // "QStandardItemModel*"
QT_MOC_LITERAL(7, 80, 5), // "model"
QT_MOC_LITERAL(8, 86, 7), // "reached"
QT_MOC_LITERAL(9, 94, 10), // "notReached"
QT_MOC_LITERAL(10, 105, 11), // "s_is_public"
QT_MOC_LITERAL(11, 117, 7), // "aPublic"
QT_MOC_LITERAL(12, 125, 7), // "aColumn"
QT_MOC_LITERAL(13, 133, 4) // "fill"

    },
    "ThreadAchievements\0s_progress\0\0progress\0"
    "max\0s_finishedModel\0QStandardItemModel*\0"
    "model\0reached\0notReached\0s_is_public\0"
    "aPublic\0aColumn\0fill"
};
...
void ThreadAchievements::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->s_progress((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        case 1: _t->s_finishedModel((*reinterpret_cast< QStandardItemModel*(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2])),(*reinterpret_cast< const int(*)>(_a[3]))); break;
        case 2: _t->s_is_public((*reinterpret_cast< const bool(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (ThreadAchievements::*)(const int & , const int & );
        ...
        {
            using _t = void (ThreadAchievements::*)(QStandardItemModel * , const int & , const int & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadAchievements::s_finishedModel)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ThreadAchievements::*)(const bool & , const int & );
...
// SIGNAL 0
void ThreadAchievements::s_progress(const int & _t1, const int & _t2)
{
...
// SIGNAL 1
void ThreadAchievements::s_finishedModel(QStandardItemModel * _t1, const int & _t2, const int & _t3)
{
...
// SIGNAL 2
void ThreadAchievements::s_is_public(const bool & _t1, const int & _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
