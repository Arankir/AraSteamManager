...
#include <memory>
#include "../../AraSteamManager/subWidgets/qcomboboxfriends.h"
...
QT_MOC_LITERAL(3, 34, 5) // "clear"
    ...
    "ComboBoxFriends\0selectionChanged\0\0"
    "clear"
};
...
void ComboBoxFriends::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ComboBoxFriends::selectionChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ComboBoxFriends::selectionChanged()
{
