...
QT_INIT_METAOBJECT const QMetaObject ThreadLoading::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ThreadLoading.data,
