/****************************************************************************
** Meta object code from reading C++ file 'profile2.h'
**
...
#include "../../AraSteamManager/profile2.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'profile2.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 11), // "OnResultGet"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 14), // "QNetworkReply*"
QT_MOC_LITERAL(4, 36, 5) // "reply"

    },
    "Profile\0OnResultGet\0\0QNetworkReply*\0"
    "reply"
};
...
void Profile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OnResultGet((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
