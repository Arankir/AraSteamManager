...
QT_MOC_LITERAL(36, 0), // ""
QT_MOC_LITERAL(37, 10), // "Category2*"
QT_MOC_LITERAL(48, 8), // "category"
QT_MOC_LITERAL(57, 9) // "isChecked"

    },
    "CategoriesModel\0s_checkStateChanged\0"
    "\0Category2*\0category\0isChecked"
};
...
void CategoriesModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->s_checkStateChanged((*reinterpret_cast< Category2*(*)>(_a[1])),(*reinterpret_cast< const bool(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CategoriesModel::*)(Category2 * , const bool & );
...
, QtPrivate::TypeAndForceComplete<CategoriesModel, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<Category2 *, std::false_type>, QtPrivate::TypeAndForceComplete<const bool &, std::false_type>
...
// SIGNAL 0
void CategoriesModel::s_checkStateChanged(Category2 * _t1, const bool & _t2)
{
