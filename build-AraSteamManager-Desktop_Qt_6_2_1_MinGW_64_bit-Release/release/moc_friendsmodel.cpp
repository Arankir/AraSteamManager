...
static const uint qt_meta_data_FilterModelFriends[] = {
...
void FilterModelFriends::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
...
const QMetaObject FilterModelFriends::staticMetaObject = { {
    QMetaObject::SuperData::link<FilterModel::staticMetaObject>(),
    qt_meta_stringdata_FilterModelFriends.offsetsAndSize,
    qt_meta_data_FilterModelFriends,
    qt_static_metacall,
    nullptr,
...
const QMetaObject *FilterModelFriends::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *FilterModelFriends::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_FilterModelFriends.stringdata0))
        return static_cast<void*>(this);
    return FilterModel::qt_metacast(_clname);
}

int FilterModelFriends::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
