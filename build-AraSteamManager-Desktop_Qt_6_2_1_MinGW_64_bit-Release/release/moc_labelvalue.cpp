...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_LabelValue_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_LabelValue_t qt_meta_stringdata_LabelValue = {
    {
QT_MOC_LITERAL(0, 10) // "LabelValue"
...
const QMetaObject LabelValue::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_meta_stringdata_LabelValue.offsetsAndSize,
    qt_meta_data_LabelValue,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_LabelValue_t
, QtPrivate::TypeAndForceComplete<LabelValue, std::true_type>
