...
#include <memory>
#include "../../AraSteamManager/subWidgets/charts/piechart.h"
...
void PieChart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateSettings((*reinterpret_cast< QFlags<changedSettings>(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject PieChart::staticMetaObject = { {
    ...
    qt_meta_stringdata_PieChart.offsetsAndSize,
