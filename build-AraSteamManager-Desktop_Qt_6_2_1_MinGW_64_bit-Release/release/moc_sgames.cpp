...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SGame_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SGame_t qt_meta_stringdata_SGame = {
    {
QT_MOC_LITERAL(0, 5) // "SGame"
...
const QMetaObject SGame::staticMetaObject = { {
    QMetaObject::SuperData::link<Sapi::staticMetaObject>(),
    qt_meta_stringdata_SGame.offsetsAndSize,
    qt_meta_data_SGame,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SGame_t
, QtPrivate::TypeAndForceComplete<SGame, std::true_type>
