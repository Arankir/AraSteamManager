...
public:
    ...
    ButtonReachedType *FilterMyProfile;
    ...
    void setupUi(QWidget *FormAchievements)
    {
        ...
        FilterMyProfile = new ButtonReachedType(FrameFilter);
        ...
        horizontalLayout_6->addWidget(FilterMyProfile);
    ...
    void retranslateUi(QWidget *FormAchievements)
    {
        ...
        FilterMyProfile->setText(QString());
#if QT_CONFIG(tooltip)
