...
#include <memory>
#include "../../AraSteamManager/subWidgets/tables/mytable.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MyTable_t, stringdata0) + ofs), len 
...
const QMetaObject MyTable::staticMetaObject = { {
    ...
    qt_meta_stringdata_MyTable.offsetsAndSize,
    qt_meta_data_MyTable,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MyTable_t
