...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SBan_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SBan_t qt_meta_stringdata_SBan = {
    {
QT_MOC_LITERAL(0, 4) // "SBan"
...
const QMetaObject SBan::staticMetaObject = { {
    QMetaObject::SuperData::link<Sapi::staticMetaObject>(),
    qt_meta_stringdata_SBan.offsetsAndSize,
    qt_meta_data_SBan,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SBan_t
, QtPrivate::TypeAndForceComplete<SBan, std::true_type>
