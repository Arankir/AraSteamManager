...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SFriend_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SFriend_t qt_meta_stringdata_SFriend = {
    {
QT_MOC_LITERAL(0, 7) // "SFriend"
...
const QMetaObject SFriend::staticMetaObject = { {
    ...
    qt_meta_stringdata_SFriend.offsetsAndSize,
    qt_meta_data_SFriend,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SFriend_t
, QtPrivate::TypeAndForceComplete<SFriend, std::true_type>
